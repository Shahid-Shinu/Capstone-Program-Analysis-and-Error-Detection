'''
To Run:
Enter: python2.7 interface.py
Enter: ./<name of your c program to be visualised>.c
If Error persists make sure there is atleast one global and local variable
Check if corresponding libraries are installed
Keep Terminal Full Screen for legible display
'''
'''
Pointers done-2018
To be done:
